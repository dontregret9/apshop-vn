...
function NavigationBar(props) {
    return (
        <nav id="NavigationBar" class="navbar navbar-dark">
            <img src="https://theme.hstatic.net/1000129940/1000623473/14/logo.png?v=94" />
            ...
            <div className="d-flex">
                ...
                <div id="right-info">
                    <div id="right-top" className="d-flex ">
                        <div id="loggin" className="d-flex p-pointer">
                        ...
                        <p className="p-pointer">Đăng ký</p>
                    ...
                    <div id="right-bottom" className="d-flex">
                        <p className="p-pointer">0938 975 268</p>
                        <p className="p-pointer">Liên Hệ</p>
                        <p className="p-pointer">Công Nghệ</p>
                        <p className="p-pointer">Hàng Mới Về </p>
                    </div>
                </div>
